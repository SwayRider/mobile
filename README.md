...
SwayRider is a prototype navigation application for scooters and e-bikes. It provides route planning, location search, and map-based navigation optimized for urban micro-mobility.
